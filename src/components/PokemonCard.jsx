...
function PokemonCard({ pokemon, isFavorite, onToggleFavorite, onBlockPokemon }) {
  ...
  return (
    <div className="bg-purple-200/60 border border-purple-300 p-5 rounded-2xl shadow-sm flex flex-col items-center justify-between transition-all duration-200 hover:shadow-md hover:border-purple-400">
      ...
      <div className="grid grid-cols-2 gap-2 w-full">
        <button
          ...
          className={`py-2 px-1 rounded-xl text-[11px] font-bold transition-all duration-150 flex items-center justify-center gap-1 cursor-pointer shadow-sm ${
            isFavorite
        ...
        <button
          ...
          className="py-2 px-1 rounded-xl text-[11px] font-bold bg-red-100 hover:bg-red-200 text-red-700 border border-red-200/50 transition-all duration-150 flex items-center justify-center gap-1 cursor-pointer shadow-sm"
